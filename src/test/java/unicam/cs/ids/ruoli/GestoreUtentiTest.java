...
public class GestoreUtentiTest {
    ...
    public void inizializzazioneVariabili() {
        ...
        Comune civitanova = new Comune("Civitanova Marche", "MC", "1", new PuntoFisico(new Coordinate(43.308, 13.700)));
        Comune camerino = new Comune("Camerino", "MC", "2", new PuntoFisico(new Coordinate(43.135, 13.067)));
