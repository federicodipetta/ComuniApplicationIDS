...
public class AnalizzatorePuntoFisicoTest {
    ...
    public void controllaPuntoFisicoTest() throws IOException, JSONException {
        ...
        PuntoFisico puntoFisico2 = new PuntoFisico(new Coordinate(43.1397222, 13.068333333333333)); // Camerino.
        assertFalse(analizzatorePuntoFisico.controllaPuntoFisico(puntoFisico2, comune));
        PuntoFisico puntoFisico3 = new PuntoFisico(new Coordinate(76.7841667, 68.99527777777777)); // Novaja Zemlja.
    ...
    public void controllaPuntoFisicoTest2() throws IOException, JSONException {
        ...
        PuntoFisico puntoFisico2 = new PuntoFisico(new Coordinate(41.8908333, 12.492777777777777)); // Roma.
